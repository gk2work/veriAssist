...
`ifndef VERILATOR
    #1;
`endif
    // UUT.$auto$async2sync.\cc:107:execute$166  = 1'b0;
    // UUT.$auto$async2sync.\cc:116:execute$170  = 1'b1;
    UUT._va_ap_fifo_read_write_equal_delay_3 = 1'b1;
    UUT.empty_out_prev = 1'b1;
    UUT.full_out_prev = 1'b1;
