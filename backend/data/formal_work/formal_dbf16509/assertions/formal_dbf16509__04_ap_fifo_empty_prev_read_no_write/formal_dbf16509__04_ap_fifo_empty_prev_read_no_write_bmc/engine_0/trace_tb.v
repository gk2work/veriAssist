...
`endif
    ...
    UUT.u_dut._witness_.anyinit_procdff_390 = 8'b00000000;
    UUT.u_dut._witness_.anyinit_procdff_395 = 1'b0;
    UUT.u_dut._witness_.anyinit_procdff_400 = 5'b00000;
    UUT.u_dut._witness_.anyinit_procdff_405 = 1'b0;
    ...
    // UUT.u_monitor.$auto$async2sync.\cc:107:execute$446  = 1'b0;
    // UUT.u_monitor.$auto$async2sync.\cc:116:execute$450  = 1'b1;
    UUT.u_monitor.empty_out_prev = 1'b0;
    UUT.u_monitor.rst_n_in_past1 = 1'b0;
